#ifndef PAINT_NOISE_INCLUDED
#define PAINT_NOISE_INCLUDED
...
float4 fragGNoise(Varyings i) : SV_Target
{
	float4 noise;
...
float4 fragFNoise(Varyings i) : SV_Target
{
...
float4 fragVNoise(Varyings i) : SV_Target
{
