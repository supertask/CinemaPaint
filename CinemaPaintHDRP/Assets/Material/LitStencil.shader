Shader "HDRP/LitStencil"
{
    Properties
    {
        ...
        _Smoothness("Smoothness", Range(1.0, 1.0)) = 0.5
        ...
        // Forward
        [HideInInspector] _StencilRef("_StencilRef", Int) = 1 // StencilUsage.Clear
    ...
    SubShader
    {
        ...
        Tags{ "RenderPipeline"="HDRenderPipeline" "RenderType" = "HDLitShader"  "Queue" = "Overlay+100" }
        ...
        {
            Name "Forward"
            Tags { "LightMode" = "Forward"  "Queue" = "Overlay+1000"  } // This will be only for transparent object based on the RenderQueue index
